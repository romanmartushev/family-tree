...
new Vue({
    ...
    methods: {
        fixHeaderMessage: function() {
            const vm = this;
            var message = 'Welcome to the dark page!'.split('');
            message.forEach(function(letter){
                vm.header.message.push({message: letter, isActive: false});
            });
        },
        fixBodyMessage: function() {
            const vm = this;
            ...
            messageArry.forEach(function(letter){
                vm.body.message.push({message: letter, isActive: false});
            });
        },
